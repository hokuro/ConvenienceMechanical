...
public class ContainerAutoHarvest extends Container {
	public final static int ROW_SLOT = 6;
	public final static int COL_SLOT = 9;

	private final World world;
	private final IInventory playerInventory;
	private final TileEntityHarvester seedInventory;
	private int xCoord;
	private int yCoord;
	private int zCoord;
	...
	public ContainerAutoHarvest(EntityPlayer pl, TileEntity te, World wd, int x, int y, int z){
		...
		seedInventory = (TileEntityHarvester)te;
	    ...
	    // ツールインベントリ
	    addSlotToContainer(new Slot(this.seedInventory, ROW_SLOT*COL_SLOT, 177, 17)
        {
	...
	public void setDeliverMode(Boolean deliver) {
		((TileEntityHarvester)seedInventory).setField(1, BooleanUtils.toInteger(deliver));
	}

	public World getWorld() {
		return seedInventory.getWorld();
	}
}
