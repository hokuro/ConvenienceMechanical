...
public class BlockIPSCellMaker extends BlockMachineContainer {

	public BlockIPSCellMaker(Block.Properties property) {
		super(property);
	}

	@Override
	public TileEntity createNewTileEntity(IBlockReader  worldIn) {
		return new TileEntityIPSCellMaker();
	}
	            			...
	            			new INamedContainerProvider() {
	        					...
	        					public Container createMenu(int id, PlayerInventory playerInv, PlayerEntity player) {
	        						...
	        						if (ent instanceof TileEntityIPSCellMaker) {
	        							return new ContainerIPSCellMaker(id, playerInv, ent);
	        						}
	        						return null;
	        					}
	        					...
	        					public ITextComponent getDisplayName() {
	        						return new TranslationTextComponent("container.ipscellmaker");
	        					}
	        				},
	            			(buf)->{
