...
public class BlockLivingCreator extends BlockMachineContainer {

	public BlockLivingCreator(Block.Properties property) {
		super(property);
	}

	@Override
	public TileEntity createNewTileEntity(IBlockReader  worldIn) {
		return new TileEntityLivingCreator();
	}
	            			...
	            			new INamedContainerProvider() {
	        					...
	        					public Container createMenu(int id, PlayerInventory playerInv, PlayerEntity player) {
	        						...
	        						if (ent instanceof TileEntityLivingCreator) {
	        							return new ContainerLivingCreator(id, playerInv, ent);
	        						}
	        						return null;
	        					}
	        					...
	        					public ITextComponent getDisplayName() {
	        						return new TranslationTextComponent("container.livingcreator");
	        					}
	        				},
	            			(buf)->{
