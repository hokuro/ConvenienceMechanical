...
public class GuiWoolCutting extends GuiPowerBase {

	private static final ResourceLocation tex = new ResourceLocation("cvbox:textures/gui/woolcutting.png");

	public GuiWoolCutting(ContainerPowerBase container, PlayerInventory playerInv, ITextComponent titleIn){
    ...
    protected void actionPerformed(int id, Button button) {
    	...
    	if (w != 0 || d != 0){
        	MessageHandler.SendMessage_WoolCutting_AreaSizeUpdate(w,d);
    	}
