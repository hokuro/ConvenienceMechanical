...
public class GuiVacumer extends GuiContainer {
	private static final ResourceLocation tex = new ResourceLocation("cvbox", "textures/gui/vacumer.png");


	private TileEntityVacumer te;


	public GuiVacumer(EntityPlayer player, IInventory tileEntity){
		super(new ContainerVacumer(player.inventory, tileEntity));
		te = (TileEntityVacumer)tileEntity;
	}

	@Override
	protected void drawGuiContainerForegroundLayer(int i, int j){
		fontRenderer.drawString("Vacumer",8,4,4210752);
