...
public class GuiLiquidMaker extends GuiPowerBase {
	private static final ResourceLocation tex = new ResourceLocation("cvbox", "textures/gui/liquidmaker.png");

	public GuiLiquidMaker(ContainerPowerBase container, PlayerInventory playerInv, ITextComponent titleIn){
	...
	protected void drawGuiContainerForegroundLayer(int i, int j){
		font.drawString("LiquidMaker",8,4,4210752);
