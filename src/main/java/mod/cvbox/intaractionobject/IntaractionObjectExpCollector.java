...
public class IntaractionObjectExpCollector implements IInteractionObject {
	private BlockPos entPos;

	public IntaractionObjectExpCollector(BlockPos pos){
		entPos = pos;
	}
	...
	public Container createContainer(InventoryPlayer playerInventory, EntityPlayer playerIn) {
		...
		if (ent instanceof TileEntityExpCollector){
			return new ContainerExpCollector(playerIn.inventory, (IInventory)ent);
		}
		return null;
	}
	...
	public String getGuiID() {
		// TODO 自動生成されたメソッド・スタブ
		return ModCommon.MOD_ID + ":" + ModCommon.GUIID_EXPCOLLECTOR;
	}
