...
//			.setUnlocalizedName(NAME_PLASTIC);
//	public static final Item item_HeavyMatter = new Item()
//			.setUnlocalizedName(NAME_HEAVYMATTER);
...
//	public static final Item item_Bomb = new ItemBomb()
//			.setUnlocalizedName(NAME_ITEMBOMB);
//	public static final Item item_WaterBomb = new ItemWaterBomb()
...
//	public static final Item item_ItemNCMissile = new ItemMissile()
//			.setMissileType(1)
...
//		GameRegistry.register(item_ItemNCMissile, new ResourceLocation(ModCommon.MOD_ID+":"+NAME_ITEMNCMISSILE));
...
//			ModelLoader.setCustomModelResourceLocation(item_ItemNCMissile,0, new ModelResourceLocation(ModCommon.MOD_ID+":"+NAME_ITEMNCMISSILE, "inventory"));
